...
public static class ExceptionMessages
{
    ...
    public const string LoginFailed = "Логин или пароль введены неправильно";
    ...
    public const string ProfileNotContainsEducation = "В профиль ещё не добавлен это образование";
}